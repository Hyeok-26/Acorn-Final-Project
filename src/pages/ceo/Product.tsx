...
function Product() {
  ...
  const move = (pageNum: number) => {
    ...
    const newUrl = `/product?pageNum=${pageNum}${query ? '&' + query : ''}`;
    navigate(newUrl);
  };
  ...
  return (
    <div className="container mt-5">
      ...
      <Row className="mb-3">
        ...
        <Col>
          <Form.Control type="text" name="keyword" value={searchState.keyword} onChange={handleSearchChange} placeholder="검색어 입력" />
        </Col>
        <Col>
